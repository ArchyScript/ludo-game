          ...
          */
          if (eachPlayingPathClassList.includes(`${seedStatus} ${activeSeedClass}`) || eachPlayingPathClassList.includes(`${doubleSeedStatus} ${doubleActiveSeedClass}`) || eachPlayingPathClassList.includes(`${tripleSeedStatus} ${tripleActiveSeedClass}`) || eachPlayingPathClassList.includes(`${quadrupleSeedStatus} ${quadrupleActiveSeedClass}`)) {  
            ...
            */ 
            ...
            /* 
              A function to check if a player move is valid
            */
            checkIfPlayerMoveIsValidFunction(eachPlayingPath)
            /* 
...
function countSeedInHomePathFunction (toCountDice) {
  // function countDiceInHomePathFunction () {
  //   // if (countingDice === firstDice.value && countingDice === secondDice.value ) return firstDice.value = ""

  //   // if (toCountDice === firstDice.value) return firstDice.value = "" 
  //   // if (toCountDice === secondDice.value) return secondDice.value = "" 
  
  //   if (firstDice.value || secondDice.value) return
  //   console.log("kdg,d knl dlamd' a;lattest")
  // }
  // countDiceInHomePathFunction()
...
// Todos
// Check if rolled dice is a double six
// Check if the next players turn has at least a seed on the game board
// Test the player movement in the playing path